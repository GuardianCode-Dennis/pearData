...
<div class="fixed inset-0 w-full h-dvh flex justify-center items-center z-[200] bg-primary/20 backdrop-blur-lg p-6 shadow-2xl {$showTokenPopup ? '' : 'opacity-0 invisible'} transition-all">
