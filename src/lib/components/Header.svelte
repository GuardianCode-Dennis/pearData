...
<div class="fixed lg:hidden bottom-0 left-0 w-screen h-20 bg-primary/20 z-[100] backdrop-blur-3xl flex justify-between items-center px-6">
    <div>
        menu
    </div>
    <div class="w-[150px]">
        <Button title="Start trading" href="https://www.google.nl" target="_blank" />
    </div>
</div>